...
import RelifeAnimation from '../animation/RelifeAnimation'
...
export class Player extends Phaser.GameObjects.Image {
  ...
  private relifeAnimation: RelifeAnimation
  ...
  constructor(aParams: IImageConstructor) {
    ...
    this.relifeAnimation.playGoUpTween()
  }
  ...
  private initVariables(): void {
    ...
    this.relifeAnimation = new RelifeAnimation(this)
  }
  ...
  private handleFlying(): void {
    if (this.cursors.right.isDown && this.x < this.scene.sys.canvas.width - this.width / 2) {
